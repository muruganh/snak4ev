...
class WalletViewController: BaseViewController,RazorpayPaymentCompletionProtocol{
    ...
    func loadWalletBalance(){
        let walletParams = ["customerid": UserDetails.UserDetailModel?.customerid ?? ""] as [String : Any]
    ...
    func onPaymentSuccess(_ payment_id: String) {
        let walletParams = ["customerid": UserDetails.UserDetailModel?.customerid ?? "", "walletamt": self.selectedAmount] as [String : Any]
